...
export default {
  ...
  "glossary.workspace.p3": "связывает «Чтение», «Граф», «Чат» и «Доказательства» с этой статьёй.",
  ...
  "evidence.header.description":
    "Отпечатки чанков и превью текста для трассировки ответов агента. Откройте из «Чтения» (панель чанков), по ссылке из «Чата» или по deep-link с work_id в URL.",

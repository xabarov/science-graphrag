...
Orchestration delegates to ``stream_phase_*`` modules; product-step constants and
helpers are re-exported here for backward-compatible imports (e.g. tests).
"""

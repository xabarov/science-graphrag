...
TOOL_MANIFEST: tuple[ToolManifestEntry, ...] = (
    ...
    ToolManifestEntry(
        "official_web_lookup",
        "external",
        ("web", "official", "vendor", "docs", "github", "product", "release"),
        "medium",
        "corpus",
        "retrieval_agent",
        False,
        "Curated official vendor/docs/GitHub URLs for known products",
        "tool://official_web_lookup",
        True,
        source_family="http",
    ),
    ToolManifestEntry(
    ...
    ToolManifestEntry(
        ...
        "retrieval_agent",
        False,
        "Search OpenAlex works by query (metadata discovery; use doi_resolver for DOI lookup)",
        "tool://openalex_works_search",
        True,
    ...
    ToolManifestEntry(
        ...
        "retrieval_agent",
        False,
        "Fetch one Semantic Scholar paper record by id (metadata)",
        "tool://semantic_scholar_paper",
        True,
        source_family="semantic_scholar",
    ),
    ToolManifestEntry(
        ...
        "retrieval_agent",
        False,
        "Read text excerpt from external PDF URL",

...
DEFAULT_AGENT_V3_QUALITY_JUDGE_MINI = "eval/results/current-agent-v3-quality-judge-mini.json"
DEFAULT_AGENT_V3_QUALITY_JUDGE_PILOT = "eval/results/current-agent-v3-quality-judge-pilot.json"
DEFAULT_AGENT_V3_QUALITY_JUDGE_HOLDOUT = "eval/results/current-agent-v3-quality-judge-holdout.json"
DEFAULT_AGENT_V3_QUALITY_JUDGE_COMPARE = "eval/results/current-agent-v3-quality-judge-compare.json"
...
class BenchmarkLogicalId(StrEnum):
    ...
    AGENT_V3_QUALITY_JUDGE_MINI = "benchmark.canonical.agent_v3_quality.judge_mini"
    AGENT_V3_QUALITY_JUDGE_PILOT = "benchmark.canonical.agent_v3_quality.judge_pilot"
    AGENT_V3_QUALITY_JUDGE_HOLDOUT = "benchmark.canonical.agent_v3_quality.judge_holdout"
    AGENT_V3_QUALITY_JUDGE_COMPARE = "benchmark.canonical.agent_v3_quality.judge_compare"

...
> **2026-04-27:** Перенесено в `_archive/`; короткий stub с ссылкой сюда: [`../agent-chat-frontend-verification-gaps-next-wave.md`](../agent-chat-frontend-verification-gaps-next-wave.md).

**Date:** 2026-04-26 (updated same day)  
**Source plan:** [`../agent-chat-frontend-ui-plan-2026-04-26.md`](../agent-chat-frontend-ui-plan-2026-04-26.md) §12 (Verification plan)

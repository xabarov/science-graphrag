...
Краткая сводка закрытых фаз и headline-цифр: [`completed-work-snapshot.md`](./completed-work-snapshot.md#corpus-gold-pack-v1).

**Полный пофазный пост-мортем (Phase 0–6.E):** [`_archive/corpus-gold-pack-v1-phase-log-2026-04-25.md`](./_archive/corpus-gold-pack-v1-phase-log-2026-04-25.md).

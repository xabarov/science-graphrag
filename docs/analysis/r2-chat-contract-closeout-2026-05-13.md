...
4. **Docs sync:** [`agent-engine-and-benchmarks-next-waves-2026-05-09.md`](./agent-engine-and-benchmarks-next-waves-2026-05-09.md) §9 table — trace-review split backlog item marked **DONE**; [`agent-engine-next-horizon-2026-05-13.md`](./agent-engine-next-horizon-2026-05-13.md) §6.1 aligned with **actual** R1 package layout (facade + `trace_review/` + `trace_compare/`).

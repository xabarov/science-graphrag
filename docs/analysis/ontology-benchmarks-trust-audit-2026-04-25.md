...
- **Phase 6.E pending (опционально):** second/third model pass (`anthropic/claude-sonnet-4.6` ≈$0.20, `moonshotai/kimi-k2.6` ≈$0.04). Triple-vote снимет single-model bias и потенциально разблокирует ещё 5-15 авто-промоутов из текущих 38 high-priority packs (19 claims + 8 concepts + 3 contradictions + 3 ideas + 3 retrieval + 3 agent + 0 dedup).

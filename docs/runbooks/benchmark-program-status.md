...
| **Agent v3 quality judge (Wave B / Wave C / Wave D tooling)** | Pairwise answer quality: `langgraph_research_v1` vs `langgraph_supervisor_v3` + judge | **Advisory-only**; не входит в `_decision_gate`; CLI `science-graphrag-agent-v3-quality-benchmark`; артефакты `current-agent-v3-quality-judge-{mini,pilot,holdout}.json`, опционально `current-agent-v3-quality-judge-compare.json`; **Wave C** — KPI/cadence/baseline/compare и сводка в `benchmark-metrics-summary` (`agent_v3_quality_family`); **Wave D (2026-05)** — calibration window CLI, fingerprint guard, `compare --release-train-gate`, см. [`eval/agent_v3_quality/README.md`](../../eval/agent_v3_quality/README.md), [`agent-v3-quality-judge-calibration-2026-05.md`](../analysis/agent-v3-quality-judge-calibration-2026-05.md), [`agent-engine-next-horizon-2026-05-13.md`](../analysis/agent-engine-next-horizon-2026-05-13.md), [`agent-engine-feature-status-2026-05-13.md`](../analysis/agent-engine-feature-status-2026-05-13.md); historical detailed wave log: [`agent-engine-and-benchmarks-next-waves-2026-05-09.md`](../analysis/agent-engine-and-benchmarks-next-waves-2026-05-09.md) (stub); **pre-F operator evidence bundle** — [`pre-f-closure-wave-d-evidence-2026-05-12.md`](../analysis/pre-f-closure-wave-d-evidence-2026-05-12.md) |

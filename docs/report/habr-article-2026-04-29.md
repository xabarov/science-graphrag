...
- **Публикационные прогоны.** Для текста статьи фиксирую дату, коммит и JSON в `eval/results/` (см. май 2026: `habr-window-2026-05-manifest.txt`). План правок текста и бенчмарков на следующий месяц — [`habr-article-plan-2026-06.md`](../analysis/habr-article-plan-2026-06.md).
...
*Про текст статьи и измеримые «beats» на ближайший месяц — отдельный чеклист:* [`habr-article-plan-2026-06.md`](../analysis/habr-article-plan-2026-06.md).

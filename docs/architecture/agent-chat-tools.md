...
**Связанные материалы:** [`docs/specs/agent-chat-v1.md`](../specs/agent-chat-v1.md), [`docs/analysis/agent-runtime-tools-context-roadmap-2026-05-04.md`](../analysis/agent-runtime-tools-context-roadmap-2026-05-04.md), [`science_graphrag/agent/prompts/research_chat_system.py`](../../science_graphrag/agent/prompts/research_chat_system.py), статический манифест для rule-based отбора: [`science_graphrag/agent/tool_manifest.py`](../../science_graphrag/agent/tool_manifest.py).

...
Each grid cell predictsB bounding boxes and confidence
...
mally we define confidence asPr(Object)∗ IOUtruth
pred . If no
...
S × S × (B ∗ 5 + C) tensor.
For evaluating YOLO on PASCAL VOC, we useS = 7 ,
B = 2 . P ASCAL VOC has 20 labelled classes so C = 20 .
Our final prediction is a7× 7× 30 tensor.
2.1. Network Design
...
andy coordinates to be offsets of a particular grid cell loca-
...
use two parameters,λcoord andλnoobj to accomplish this. We
setλcoord = 5 andλnoobj =.5.
...
stead of sliding windows to find objects in images. Selective
...
[16] B. Hariharan, P. Arbel ́aez, R. Girshick, and J. Malik. Simul-
...
[39] C. L. Zitnick and P. Doll ́ar. Edge boxes: Locating object pro-

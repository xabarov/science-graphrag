...
|------|----------------------|--------|
| arXiv PDF | `"pdf_read_request":{"pdf_url":"https://arxiv.org/pdf/1706.03762.pdf"},"question":" "` (or token `__sg_pdf_read_action__`) | SSE shows `pdf_read_*` steps; answer cites extracted text or tool trace `read_external_pdf` ok |
